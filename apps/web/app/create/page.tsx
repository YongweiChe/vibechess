                ...
                {canPlayAnotherGameWhileWaiting ? (
                  <div className="mt-4 flex items-center justify-between gap-3">
                    <Link
                      ...
                      target="_blank"
                      className="inline-flex items-center px-3 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full text-xs font-medium hover:from-purple-700 hover:to-blue-700 transition-all shadow-md hover:shadow-lg"
                    >
                  ...
                  <Link
                    href={`${getGameServerUrl()}/game/tetris-battle`}
                    className="inline-flex items-center px-3 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full text-xs font-medium hover:from-purple-700 hover:to-blue-700 transition-all shadow-md hover:shadow-lg cursor-not-allowed"
                  >
                    🎮 Play another game while you wait
                  </Link>
                )}
